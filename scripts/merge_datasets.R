...
# BRCA2 IR iRFP720 ----------------------------------------------------------------
all_data <- list()
datasets <- c("181005 BRCA2-Halo PCNA-iRFP IR tracking/","181010 BRCA2-Halo PCNA-iRFP IR tracking/","181012 BRCA2-Halo PCNA-iRFP IR tracking/")
...
save(all_data,file = file.path("Tracking data merged/","BRCA2_IR_all_data.Rdata"))
load(file.path("Tracking data merged/","BRCA2_IR_all_data.Rdata"))
